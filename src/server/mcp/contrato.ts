...
1. Se você consegue controlar o navegador dele (Claude for Chrome), ABRA o perfil do LinkedIn dele — a URL está em bryanai_profile_read, campo "linkedin"; se vier vazio, pergunte a ele — e LEIA a página. Role até o fim para carregar as seções de experiência, formação e licenças, e clique em "Ver mais"/"Show all" onde houver, porque o LinkedIn corta listas longas. Passe SÓ o perfil dele — deixe de fora "pessoas que você talvez conheça", "perfis semelhantes" e qualquer bloco de outra pessoa, senão o histórico de terceiros entra como se fosse dele.
